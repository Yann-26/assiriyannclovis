...
# Keep the original Blog model but enhance it
class Blog(models.Model):
    ...
    # Blog Details
    blog_type = models.CharField(max_length=20, choices=BLOG_TYPES, default="article")
    category = models.ForeignKey(
        Category, on_delete=models.SET_NULL, null=True, blank=True
    )
    tags = models.ManyToManyField(Tag, blank=True)
    ...
    excerpt = models.TextField(
        max_length=500, blank=True, help_text="Short excerpt for preview"
    )
